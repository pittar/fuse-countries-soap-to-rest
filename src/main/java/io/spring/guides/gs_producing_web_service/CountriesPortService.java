...
@WebServiceClient(name = "CountriesPortService",
                  wsdlLocation = "http://countries-soap-ws-soap.apps.cluster-c2ed.c2ed.example.opentlc.com/ws/countries.wsdl",
...
public class CountriesPortService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://countries-soap-ws-soap.apps.cluster-c2ed.c2ed.example.opentlc.com/ws/countries.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CountriesPortService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://countries-soap-ws-soap.apps.cluster-c2ed.c2ed.example.opentlc.com/ws/countries.wsdl");
        }
        WSDL_LOCATION = url;
    }
